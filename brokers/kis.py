...
# BUYLOW_KIS_TOKEN_CACHE로 옮길 수 있다(Docker는 bind-mount된 /app/state로 보내 영속화).
DEFAULT_TOKEN_CACHE = Path(os.environ.get("BUYLOW_KIS_TOKEN_CACHE") or REPO_ROOT / ".kis_token.json")
